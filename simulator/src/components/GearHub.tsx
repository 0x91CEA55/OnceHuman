...
interface GearHubProps {
    ...
    loadoutRarities: Record<string, Rarity | undefined>;
}
            ...
            {slots.map((slot) => (
                <button
                    ...
                    className={cn(
                        ...
                        activeSlot === slot.id ? "bg-primary/10 border-primary shadow-[0_0_15px_rgba(77,184,255,0.2)]" : cn(getRarityBg(loadoutRarities[slot.id]), "hover:border-primary/40"),
